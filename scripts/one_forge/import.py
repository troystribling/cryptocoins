...
if __name__ == "__main__":
    start_date = start_date_from_last_import('forex/one_forge/exchange_rates')
    end_date = end_date_from_start_date()
    logger.info(f"IMPORTING one_forge/exchange_rates {start_date} TO {end_date} FROM {bucket_name}")
